...
function btn_edit($uri){
    return anchor($uri, '<i class="btn btn-success fa fa-pencil-square-o"></i>');
}

function btn_delete($uri){
    return anchor($uri, '<i class="btn btn-danger fa fa-eraser"></i>', array(
        'onclick' => "return confirm('You are about to delete a record. This canot be undone Are you  sure?');"
    ));
}
